    ...
    <div>
      ...
      <div className="home_first_segment_container">
        <div className="home_first_segment_text_container">
          <h1 className="home_first_segment_title">
            Der passende Baum für Ihren Wald
          </h1>
          <p className="home_first_segment_text">
            Verschaffen Sie sich mit unseren Analysetools einen Einblick in
            Ihren Wald und erfahren Sie, welche Baumarten geeignet sind.
          </p>
        </div>
        <img
          src={forest_image}
      ...
      <div className="home_second_segment_container">
        <div className="home_second_segment_dashboard_container">
          ...
          <p className="dashboard_info_intro_text">
            Lernen Sie Ihre Standorte zu verstehen mit Informationen zu:
          </p>
          ...
          <Link to={"/dashboard"} className="link">
            <Button
              ...
              button_style="light_grey_button_home"
            />
          </Link>
        </div>
        <div className="home_second_segment_guide_container">
          <h2 className="guide_info_title">Der Ratgeber</h2>
          <p className="guide_info_intro_text">
            Bekommen Sie konkrete Vorschläge zur Beforstung Ihres Standorts:
          </p>
          ...
          <Link to={"/guide"} className="link">
            <Button
              button_text="Zum Ratgeber"
              button_style="green_button_home"
            />
          </Link>
        </div>
      </div>
      <div className="third_segment_container">
        <h2 className="third_segment_title">
          Alles ganz genau im Blick mit Hilfe der IoT Module
        </h2>
      ...
      <div className="fourth_segment_container">
        <h3 className="fourth_segment_title">
          Lernen Sie den Wald verstehen mit Hilfe der Forstler Blogs
        </h3>
        <div className="blogs_container">
          <div className="blog_container">
            ...
            ></img>
            <p className="blog_intro_text">
              Bodenbeschaffenheit - Ein Schlüsselfaktor für die Gesundheit von
              Bäumen
            </p>
          </div>
          <div className="blog_container">
            ...
            ></img>
            <p className="blog_intro_text">
              Der Standort - Welche Rolle spielt der Standort und die Lage des
              Waldes?
            </p>
          </div>
        </div>
      ...
      <div className="footer_segment">
        ...
        <div className="buttons_container">
          <Link to={"/dashboard"} className="link">
            <Button
              button_text="Zum Dashboard"
              button_style="light_grey_button"
            />
          </Link>
          <Link to={"/guide"} className="link">
            <Button
